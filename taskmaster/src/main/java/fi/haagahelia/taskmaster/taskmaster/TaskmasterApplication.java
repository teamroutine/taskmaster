...
public class TaskmasterApplication {
	...
	@Bean
    public CommandLineRunner demo(PanelRepository prepository, TeamRepository trepository) {
        return (args) -> {
            ...
            Panel panel1 = new Panel(null, "Testi projekt", "testi projekti testaukseen");
			
            Panel panel2 = new Panel(null, "new project", "test for project testing");
